...
export default function Home() {
  ...
  const addItem = async (item) => {
    ...
    if (docSnap.exists()) {
      // If the document exists, update the count
  ...
  return (
    ...
    >
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h6" component="h2" fontWeight={100}>
            Add Item
          </Typography>
      ...
      <Box border={'1px solid #333'}>
        ...
        >
          ...
          <Typography variant={'h2'} color={'#333'} textAlign={'center'} fontWeight={200}>
            Pantry Items
          </Typography>
        </Box>
